...
def csv_import():
    ...
    for i in ["go_sleep_", "pass_out_", "just_lay_"]: #modified
        ...
        xx = np.array(pd.read_csv("./input_files/xx_1000_60_" + str(i) + ".csv", header=None, skiprows = skip_idx)) #skip_idx 여기 잘해야함. window size 1000에서 500으로 줌
    ...
    return x_dic["go_sleep_"], x_dic["pass_out_"], x_dic["just_lay_"],\
        y_dic["go_sleep_"], y_dic["pass_out_"], y_dic["just_lay_"]
